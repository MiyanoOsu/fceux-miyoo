...
static int listcallb(const char *name, uint32 a, uint8 v, int compare, int s, int type, void *data) {
    CheatList *list;
...
int 
CheatList::Add(const char *name, uint32 a, uint8 v, int c, int s, int type, void *data)
{
	CheatData cd;
	char codeStr[32];
